...
(function($, undefined) {
	...
	Calendar.prototype = {
		...
		init: function ( type, element, options ) {
			...
			this.monthOjb = $("<div ><div class='slides-inner' ><div id='day-slider-0' style='width:" + width + "px;height:" + height + "px;'>" + 
				month.renderDays() + "</div><div id='day-slider-1' style='width:" + width + "px;height:" + height + "px;'>" + 
				nextMonth.renderDays() + "</div><div id='day-slider-2' style='width:" + width + "px;height:" + height + "px;'>" + 
				prevMonth.renderDays() + "</div></div></div>");
		...
		renderCalendar: function () {
			...
			for(var i = 0; i < 	this.localization.dayNamesShort.length; ++i) {
				html += "<td>" + this.localization.dayNamesShort[i] + "</td>";
			}
