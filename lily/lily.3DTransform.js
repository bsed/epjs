...
(function( $, undefined ) {
	...
	$.lily.threeDTransform = $.lily.threeDTransform || {};
	
	$.extend( $.lily.threeDTransform, {
    ...
    $.fn.css = function (arg, val) {
        ...
        if ( typeof _propsObj['transform'] == 'undefined' 
            ...
            _propsObj['transform'] = $.lily.threeDTransform.getTransformProperty(this.get(0));
        }
    ...
    var calcRotate3Di = {
        ...
        scale: function (degrees) {return (1 - (degrees % 180) / 90) * (degrees >= 180 ? -1 : 1);}
    }
